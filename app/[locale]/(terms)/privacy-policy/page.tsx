...
const Page = (): ReactElement => {
  return (
    <>
      ...
      <P>
        We are committed to ensuring that your information is secure. We follow
        industry-standard practices to protect the information collected from
        you, including the use of encryption and secure socket layer (SSL)
        technology.
      </P>
